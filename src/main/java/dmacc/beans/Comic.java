...
public class Comic {
	 ...
	 * @param list
	 */
	public Comic(String comicTitle) {
		super();
	 ...
	 * @param issuNum
	 */
	public Comic(String list, String comicTitle, int issuNum) {
		super();
		this.list = list;
		this.comicTitle = comicTitle;
	 ...
	 * @param issuNum
	 */
	public Comic(long id, String list, String comicTitle, int issuNum) {
		super();
		this.id = id;
		this.list = list;
		this.comicTitle = comicTitle;
	 ...
	 * @param string2
	 */
	public Comic(String comicTitle, int issuNum, String list) {
		// TODO Auto-generated constructor stub
		this.comicTitle = comicTitle;
		this.issuNum = issuNum;
		this.list = list;
	 ...
	 * @return the issuNum
	 */
	public int getIssuNum() {
		return issuNum;
	}
	/**
	 * @param issuNum the issuNum to set
	 */
	public void setIssuNum(int issuNum) {
		this.issuNum = issuNum;
	}
	...
	public String toString() {
		return "Comic [id=" + id + ", list=" + list + ", comicTitle=" + comicTitle + ", issuNum=" + issuNum
